...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::messages::rendering::is_untrusted_sender,
            ...
            commands::trusted_senders::add_untrusted_sender,
            commands::trusted_senders::list_untrusted_senders,
            commands::trusted_senders::remove_untrusted_sender,
